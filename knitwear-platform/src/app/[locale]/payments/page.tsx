            ...
            <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 shadow-soft border border-tan-200">
                ...
                <div className="border-b border-tan-100 pb-6 mb-8">
                    <h1 className="text-3xl font-bold text-brown-800 mb-2">
                        {isKo ? '크레딧 안내' : 'About Credits'}
                    </h1>
                    <p className="text-brown-600">
                        {isKo
                            ? '크레딧은 가입, 글쓰기, 도안 업로드 등 커뮤니티 활동을 통해 무료로 적립되며, 차트변환기·도안에디터 같은 스마트 도구를 사용할 때 소비됩니다.'
                            : 'Credits are earned for free through community activities like signing up, writing posts, or uploading patterns, and are spent on tools like the chart converter and pattern editor.'}
                    </p>
                </div>

                {/* User Status */}
                <div className="bg-cream-50 rounded-2xl p-6 border border-tan-150 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                    <a
                        ...
                        className="px-6 py-3 rounded-2xl bg-brown-600 hover:bg-brown-700 text-white font-bold transition-all duration-200 shadow-soft text-center"
                    >
                        {isKo ? '마켓플레이스 둘러보기' : 'Browse Marketplace'}
                    </a>
                    <a
                        href={`/${locale}/profile`}
                        className="px-6 py-3 rounded-2xl bg-white border border-tan-300 hover:bg-cream-50 text-brown-800 font-bold transition-all duration-200 text-center"
                    >
